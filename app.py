...
def tabelaClique(event):
    #Pegando a linha selacionada
    #Retorna o codigo da linha de uma tupla
    linhaSelecionada = tabela.selection()[0]
    global index
    #Obtendo o indice da linha a partir do codigo da linha
...
txtNome = Entry(janela, font='Tohama 14', width=27)
...
txtTelefone = Entry(janela, font='Tohama 14', width=27)
txtTelefone.grid(row=1, column=1)

labelCategoria = Label(janela, text='Categoria', fg='navy', font='Tohama 14 bold')
labelCategoria.grid(row=2, column=0)

categorias = ['Amigos', 'Trabalho', 'Familia']
comboCategoria = ttk.Combobox(janela, values=categorias, font='Tohama 14', width=25)
